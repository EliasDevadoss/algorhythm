...
Abstract Syntax: {\tt song} of {\tt int * meter * list note * list percuss * list chord}
...
Abstract Syntax: {\tt meter} of {\tt int * int}

Type: {\tt tuple}

Prec./Assoc.: n/a

Meaning: {\tt meter} is a combining form that tells the meter of a song, which is which note 
gets "the beat," and how many beats per measure
